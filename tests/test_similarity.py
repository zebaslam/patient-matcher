...
class TestSimilarityMetrics(unittest.TestCase):
    ...
    def test_normalized_similarity(self):
        self.assertAlmostEqual(string_similarity.similarity_ratio("kitten", "sitting"), 1 - 3/7)
    ...
    def test_jaccard_similarity(self):
        self.assertEqual(string_similarity.token_overlap_score("the cat", "the cat"), 1.0)
        self.assertEqual(string_similarity.token_overlap_score("the cat", "the dog"), 1/3)
    ...
    def test_jaro_similarity(self):
        self.assertAlmostEqual(string_similarity.jaro_similarity("MARTHA", "MARHTA"), 0.944, places=3)
        self.assertAlmostEqual(string_similarity.jaro_similarity("DWAYNE", "DUANE"), 0.822, places=3)
        self.assertAlmostEqual(string_similarity.jaro_similarity("ALAN", "ALLEN"), 0.783, places=3)
    ...
    def test_jaro_winkler_similarity(self):
        self.assertAlmostEqual(string_similarity.jaro_winkler_similarity("MARTHA", "MARHTA"), 0.961, places=3)
        self.assertAlmostEqual(string_similarity.jaro_winkler_similarity("DWAYNE", "DUANE"), 0.84, places=2)
        self.assertAlmostEqual(string_similarity.jaro_winkler_similarity("ALAN", "ALLEN"), 0.827, places=3)
