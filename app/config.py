...
SIMILARITY_THRESHOLDS: Final[Dict[str, float]] = config["MATCHING"]["SIMILARITY_THRESHOLDS"]
...
GENERAL_SIMILARITY_MULTIPLIER: Final[float] = SIMILARITY_THRESHOLDS["GENERAL_SIMILARITY_MULTIPLIER"]
ADDRESS_SIMILARITY_MULTIPLIER: Final[float] = SIMILARITY_THRESHOLDS["ADDRESS_SIMILARITY_MULTIPLIER"]